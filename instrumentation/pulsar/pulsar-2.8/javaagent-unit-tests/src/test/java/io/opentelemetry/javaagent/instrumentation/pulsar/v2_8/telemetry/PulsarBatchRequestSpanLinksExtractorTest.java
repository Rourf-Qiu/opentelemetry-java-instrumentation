...
class PulsarBatchRequestSpanLinksExtractorTest {
  ...
  void addsOnlyPerMessageAttributesWhenBatchAttributesAgree() {
    String topic = "persistent://public/default/test-partition-0";
    Message<?> message1 = message(topic, "message-1", SPAN_ID_1);
    Message<?> message2 = message(topic, "message-2", SPAN_ID_2);
    ...
    assertThat(spanLinks.links)
        .containsExactly(
            linkData(
                SPAN_ID_1, Attributes.builder().put(MESSAGING_MESSAGE_ID, "message-1").build()),
            linkData(
                SPAN_ID_2, Attributes.builder().put(MESSAGING_MESSAGE_ID, "message-2").build()));
  }

  @Test
  void addsDifferingBatchAttributesToEachMessageLink() {
        ...
        .containsExactly(
            linkData(
                ...
                Attributes.builder()
                    ...
                    .put(MESSAGING_DESTINATION_NAME, topic + "-partition-0")
            ...
            linkData(
                ...
                Attributes.builder()
                    ...
                    .put(MESSAGING_DESTINATION_NAME, topic + "-partition-1")
